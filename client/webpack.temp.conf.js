...
/** Split working with necessary components */
/*
optimization: {
    splitChunks: {
        chunks: 'all',
            ...
            vendors: false,
                ...
                name: "desktop-common",
                    minChunks: 1,
                    chunks: "all",
                    test: filterByEntryPoint("App")
            },
            mobile: {
                name: "mob-common",
                    minChunks: 1,
                    chunks: "all",
                    test: filterByEntryPoint("MobileApp")
            }
        }
    }
}
...
//https://github.com/webpack/webpack/issues/6717
//https://github.com/webpack/webpack.js.org/pull/2183/files#diff-e08b426c523b9305ce571576d5b640d0R72
